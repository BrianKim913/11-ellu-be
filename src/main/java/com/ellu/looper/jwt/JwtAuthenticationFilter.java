...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
    ...
    private void handleTokenExpired(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        if (refreshToken != null && jwtProvider.validateToken(refreshToken)) {
            ...
            String newAccessToken = jwtProvider.generateToken(userId, JwtExpiration.ACCESS_TOKEN_EXPIRATION);
            String newRefreshToken = jwtProvider.generateToken(userId, JwtExpiration.REFRESH_TOKEN_EXPIRATION);
